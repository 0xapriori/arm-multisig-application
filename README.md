...
|---|---|---|
| Spec (`SPEC.md`) | ✅ v0.4 (impl extends to v0.5) | shared singleton forwarder design; impl moved external_payload to consumed vault note for simpler signature binding |
...
| `multisig-core` (Rust) | ✅ | label preimage, journal encoding, ECDSA secp256k1 low-s, witness types, constraint logic |
...
| `host` native tests | ✅ 9/9 passing | adversarial cases: amount tampering, signer dup, change overflow, etc. |
